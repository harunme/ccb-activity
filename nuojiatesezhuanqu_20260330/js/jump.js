...
function openCallMiniProgram(params, calllback) {
  ...
  window.CCBBridge && window.CCBBridge.requestNative(JSON.stringify(requestObj), 'openCallMiniProgramCB');
}
...
function jumpToMiniPromInterlayer (appId, pages) {
  ...
  wx.miniProgram.navigateTo({
    url: `/pagesC/jumpMiniBtn/jumpMiniBtn?id=${appId}&url=` + encodeURIComponent(pages),
